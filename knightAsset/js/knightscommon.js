function calculate_max_floors() {
    ...
    if (effectiveRibirthTime > 60) {
        document.getElementById("Part1_EffectiveRebirthTime").value = "BestRebrithTime " + parseInt(effectiveRibirthTime / 60) + ":" + pad(parseInt(effectiveRibirthTime % 60),2);
    }
    else {
        document.getElementById("Part1_EffectiveRebirthTime").value = "BestRebrithTime 0:" + pad(effectiveRibirthTime,2);
    }
