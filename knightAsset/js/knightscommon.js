...
function load_palyerRevenu()
{
    ...
    if (this.readyState === this.DONE) {
        ...
        document.getElementById("revenu").innerHTML = " your profit:" + profit.toFixed(4) + " EOS ( Selling:" + resultObj.rows[0].selling + ",Spending:" + (parseFloat( resultObj.rows[0].spending.replace("EOS","")) + parseFloat( resultObj.rows[0].buying.replace("EOS","")) ) + " EOS )";
    }
    });
